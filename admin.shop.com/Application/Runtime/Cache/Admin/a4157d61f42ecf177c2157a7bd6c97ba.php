...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U('Admin/Article/index');?>">传送门(文章列表)</a></span>
...
<div class="list-div" id="listDiv">
    <table cellpadding="3" cellspacing="1">
        ...
        <?php if(is_array($rows)): foreach($rows as $key=>$rows): ?><tr>
            ...
            <td align="center"><?php echo ($rows["intro"]); ?></td>
            <td align="center"><?php echo ($rows["sort"]); ?></td>
            <td align="center"><img src="http://admin.shop.com/Public/images/<?php echo ($rows["status"]); ?>.gif" /></td>
            <td align="center"><img src="http://admin.shop.com/Public/images/<?php echo ($rows["is_help"]); ?>.gif" /></td>
            <td align="center">
