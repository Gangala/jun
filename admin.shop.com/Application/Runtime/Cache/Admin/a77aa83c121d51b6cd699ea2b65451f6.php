        ...
        <form enctype="multipart/form-data" action="<?php echo U();?>" method="post">
            ...
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="path" value="<?php echo ($row["path"]); ?>" size="30" />
                        <span class="require-field">*</span></td>
                </tr>
                ...
                <tr>
                    <td class="label"></td>
                    <td>
                       <input type="submit" value=" 立即修改 " class="button"/>
                    </td>
                </tr>
            </table>
        </form>
...
<script>
    ...
    //数据回显绑定ztree权限数据
    var back_menu_zNodes = <?php echo ($now_menu_permission); ?>;
    ...
    $(document).ready(function(){
        ...
        //循环选中节点
        $.each(back_menu_zNodes,function(i,v){
            console.log(v);
            //找到节点
            var menu_nodes = menu_zTree_obj.getNodeByParam("id", v);
            //选中节点
            menu_zTree_obj.checkNode(menu_nodes, true, false,true);
        })
