...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <?php if(is_array($menu_rows)): foreach($menu_rows as $key=>$top): if(($top["parent_id"]) == "0"): ?><li class="explode"  name="menu">
                        <?php echo ($top["name"]); ?>
                        <ul>
                            <?php if(is_array($menu_rows)): foreach($menu_rows as $key=>$top2): if(($top2["parent_id"]) == "1"): ?><li class="menu-item"><a href="<?php echo U($top2['path']);?>" target="main-frame"><?php echo ($top2["name"]); ?></a></li><?php endif; endforeach; endif; ?>
                        </ul>
