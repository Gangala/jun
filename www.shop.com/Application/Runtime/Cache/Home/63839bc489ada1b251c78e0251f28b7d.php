...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到啊咿呀哟！[<a href="<?php echo U('login');?>">登录</a>] [<a href="<?php echo U('reg');?>">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="<?php echo U('index');?>"><img src="http://www.shop.com/Public/images/logo1.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
			...
			<div class="user fl">
				<dl>
					...
					<dd>
						<div class="prompt">
							您好，请<a href="<?php echo U('Index/login');?>">登录</a>
						</div>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo ($row['path'][0]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo ($row['path'][0]); ?>" width="300px" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					img标签则显示小图，按此格式循环生成即可，但在第一个li上，要加上cur类，同时在第一个li 的a标签中，添加类 zoomThumbActive  -->
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($row['path'])): foreach($row['path'] as $key=>$rows): ?><li>
                                        <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($rows); ?>',largeimage: '<?php echo ($rows); ?>'}"><img src="<?php echo ($rows); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo ($row["inputtime"]); ?></li>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="http://www.shop.com/Public/images/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com/Public/images/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com/Public/images/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com/Public/images/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com/Public/images/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com/Public/images/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com/Public/images/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com/Public/images/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com/Public/images/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
