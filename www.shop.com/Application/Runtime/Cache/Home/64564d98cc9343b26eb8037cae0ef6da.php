...
<div style="clear:both;"></div>
	...
	<div class="fillin w990 bc mt15">
        <form action="<?php echo U('Order/create_order');?>" method="post">
            <div class="fillin_hd">
                <h2>填写并核对订单信息</h2>
            </div>
            ...
            <div class="fillin_bd">
                ...
                <div class="address">
                            ...
                            <h3>收货人信息 <a href="<?php echo U('Index/add_address');?>" id="address_modify">[修改]</a></h3>
                            <div class="address_info">
                                <?php if(is_array($addresses)): foreach($addresses as $key=>$row): ?><p>
                                        <?php if($key === 0): ?><input type="radio" value="<?php echo ($row["id"]); ?>" name="address_id" checked="checked" /><strong><?php echo ($row["name"]); ?></strong>  <?php echo ($row["tel"]); ?>  <?php echo ($row["province_name"]); ?> <?php echo ($row["city_name"]); ?> <?php echo ($row["area_name"]); ?> <?php echo ($row["detail_address"]); ?> </p>
                                        <?php else: ?>
                                            <input type="radio" value="<?php echo ($row["id"]); ?>" name="address_id" /><strong><?php echo ($row["name"]); ?></strong>  <?php echo ($row["tel"]); ?>  <?php echo ($row["province_name"]); ?> <?php echo ($row["city_name"]); ?> <?php echo ($row["area_name"]); ?> <?php echo ($row["detail_address"]); ?> </p><?php endif; ?>
                        ...
                        <div class="pay">
                            ...
                            <div class="pay_info">
                                <p>
                                    <input type="radio" value="1" name="pay_type_id" checked="checked"/> 微信支付
                                </p>
                                <p>
                                    <input type="radio" value="2" name="pay_type_id"/> 银联在线
                                </p>
                                <p>
                                    <input type="radio" value="3" name="pay_type_id"/> 邮局汇款
                                </p>
                                <p>
                                    <input type="radio" value="4" name="pay_type_id"/> 货到付款
                                </p>
                            </div>
                        </div>
                        <!-- 支付方式  end-->
                        ...
                        <div class="goods">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php if(is_array($goods_detail)): foreach($goods_detail as $key=>$row): ?><tr>
                                            <td class="col1"><a href=""><img src="<?php echo ($row["logo"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($row["name"]); ?></a></strong></td>
                                            <td class="col3">￥<?php echo ($row["shop_price"]); ?></td>
                                            <td class="col4"> <?php echo ($row["amount"]); ?></td>
                                            <td class="col5"><span>￥<?php echo ($row["sub_total"]); ?></span></td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5">
                                            <ul>
                                                <li>
                                                    <span><?php echo ($goods_count); ?> 件商品，总商品金额：</span>
