	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			<div class="address_hd">
				<h3>收货地址薄</h3>
                <?php if(is_array($addres_msg)): foreach($addres_msg as $key=>$address): ?><dl>
                        ...
                        <dd>
                            <a href="<?php echo U('Index/edit_address',['id'=>$address['id']]);?>">修改</a>
                            <a href="<?php echo U('Index/remove_address',['id'=>$address['id']]);?>">删除</a>
                            <?php if(($address["is_default"]) != "1"): ?><a href="">设为默认地址</a><?php endif; ?>
                        </dd>
			...
			<div class="address_bd mt10">
				<h4>新增收货地址</h4>
				<form action="<?php echo U('Index/add_address');?>" name="address_form" method="post">
						<ul>
							<li>
