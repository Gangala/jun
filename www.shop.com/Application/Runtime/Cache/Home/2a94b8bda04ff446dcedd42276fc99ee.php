...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
                    <?php if(is_array($rows)): foreach($rows as $key=>$rows1): if(($rows1["parent_id"]) == "0"): ?><div class="cat item1">
                                <h3><a href=""><?php echo ($rows1["name"]); ?></a> <b></b></h3>
                                <div class="cat_detail">
                                    <?php if(is_array($rows)): foreach($rows as $key=>$rows2): if(($rows2['parent_id']) == $rows1['id']): ?><dl class="dl_1st">
                                                <dt><a href=""><?php echo ($rows2["name"]); ?></a></dt>
                                                <dd>
                                                    <?php if(is_array($rows)): foreach($rows as $key=>$rows3): if(($rows3['parent_id']) == $rows2['id']): ?><a href=""><?php echo ($rows3["name"]); ?></a><?php endif; endforeach; endif; ?>
                                                </dd>
	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="hot none">
					<ul>
						<?php if(is_array($goods_info)): foreach($goods_info as $key=>$rows): if(($rows['goods_status']) == "4"): ?><li>
									<dl>
										<dt><a href="<?php echo U('Goods/goods');?>?id=<?php echo ($rows["id"]); ?>"><img src="<?php echo ($rows["logo"]); ?>" alt="" /></a></dt>
										<dd><a href="<?php echo U('Goods/goods');?>?id=<?php echo ($rows["id"]); ?>"><?php echo ($rows["name"]); ?></a></dd>
										<dd><span>售价：</span><strong> ￥<?php echo ($rows["shop_price"]); ?></strong></dd>
				...
				<div class="recommend none">
					<ul>
						<?php if(is_array($goods_info)): foreach($goods_info as $key=>$rows): if(($rows['goods_status']) == "1"): ?><li>
									<dl>
										<dt><a href="<?php echo U('Goods/goods');?>?id=<?php echo ($rows["id"]); ?>"><img src="<?php echo ($rows["logo"]); ?>" alt="" /></a></dt>
										<dd><a href="<?php echo U('Goods/goods');?>?id=<?php echo ($rows["id"]); ?>"><?php echo ($rows["name"]); ?></a></dd>
										<dd><span>售价：</span><strong> ￥<?php echo ($rows["shop_price"]); ?></strong></dd>
	...
	<div class="bottomnav w1210 bc mt10">
        ...
        <?php if(is_array($articlecategory_rows)): foreach($articlecategory_rows as $key=>$rows): ?><div class="bnav<?php echo ($rows["id"]); ?>">
                    <h3><b></b> <em><?php echo ($rows['name']); ?></em></h3>
                    <ul>
                        <?php if(is_array($article_rows)): foreach($article_rows as $key=>$row): if(($row['article_category_id']) == $rows['id']): ?><li><a href=""><?php echo ($row["name"]); ?></a></li><?php endif; endforeach; endif; ?>
                    </ul>
